...
## Self-Check: PASSED
- SUMMARY.md: FOUND at .planning/phases/04-multi-account-unified-view/04-02-SUMMARY.md
- src/tools/list-messages.ts: FOUND
- src/tools/list-folders.ts: FOUND
- Commit c50a593 (TDD RED list-messages): FOUND
- Commit 1ccf1c8 (feat list-messages): FOUND
- Commit c97af12 (TDD RED list-folders): FOUND
- Commit a078250 (feat list-folders): FOUND
